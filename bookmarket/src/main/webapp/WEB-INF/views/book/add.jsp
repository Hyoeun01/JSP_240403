...
<body>
	...
	<div class="container">
		<form name="newBook" action="/book/add" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					...
					cols="100" rows="4">이 책은 프로그래밍을 처음 접하는 독자들 대상으로 한 파이썬 입문서입니다. 프로그래밍에 대한 경험이 전혀 없어도 목차에 따라 문법을 익히고, 실습을 진행하면 파이썬을 쉡게 배울 수 있습니다.
					</textarea>
				</div>
			</div>
			<div class="form-group row">
